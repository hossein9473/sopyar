      ...
      <div className="container">
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div dir ='rtl' className="w-full text-justify px-4 lg:w-1/2 pt-10 md:pt-10 lg:pt-10">
              <SectionTitle
                title="چرا به ما اعتماد می‌کنند؟"
                paragraph="ما یک تیم جوان و متخصص هستیم که در ۵ سال گذشته به بیش از ۸۲۰ دانشجو کمک کردیم تا با انگیزه‌نامه، رزومه و توصیه‌نامه‌های قوی و حرفه‌ای، شانس پذیرش خود در دانشگاه‌های برتر دنیا را افزایش دهند.
